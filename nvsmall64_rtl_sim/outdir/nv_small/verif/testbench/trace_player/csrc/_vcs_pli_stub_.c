...
/* PLI routine: $nvdla_top_sc_adapter__init:misc */
#ifndef __VCS_PLI_STUB_nvdla_top_sc_adapter__init
#define __VCS_PLI_STUB_nvdla_top_sc_adapter__init
extern void nvdla_top_sc_adapter__init(int data, int reason, int iparam );
#pragma weak nvdla_top_sc_adapter__init
void nvdla_top_sc_adapter__init(int data, int reason, int iparam )
{
    static int _vcs_pli_stub_initialized_ = 0;
    static void (*_vcs_pli_fp_)(int data, int reason, int iparam ) = NULL;
    if (!_vcs_pli_stub_initialized_) {
        _vcs_pli_stub_initialized_ = 1;
        _vcs_pli_fp_ = (void (*)(int data, int reason, int iparam )) dlsym(RTLD_NEXT, "nvdla_top_sc_adapter__init");
        if (_vcs_pli_fp_ == NULL) {
            _vcs_pli_fp_ = (void (*)(int data, int reason, int iparam )) VCS_dlsymLookup("nvdla_top_sc_adapter__init");
        }
    }
    if (_vcs_pli_fp_) {
        _vcs_pli_fp_(data, reason, iparam );
...
void (*__vcs_pli_dummy_reference_nvdla_top_sc_adapter__init)(int data, int reason, int iparam ) = nvdla_top_sc_adapter__init;
#endif /* __VCS_PLI_STUB_nvdla_top_sc_adapter__init */
